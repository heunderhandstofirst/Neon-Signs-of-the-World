...
class BondSign {
  ...
  render() {
    ...
    // text("O", BondXstart + (1.45 * windowWidth) / 8, BondYstart);
    textFont("Arial");
    //////////////////////////////////////////////////////////////////////////////////
    // D Color
    // Canvas.drawingContext.miterLimit = 0;
    var BondText = "BOND";
    ...
    for (var i = 0; i < 5; i++) {
      fill(42, 138, 201);
      if (1 === i % 2) {
        fill(noise(213), 222, 144);
      }
      // var Xrectstart= windowWidth / 15 + (1.75 * i * windowWidth) / 10;
      // var Yrectstart=BondYstart * 1.25
      rect(
...
// fill(getBondFill(FontLayer, CC[1]));
// stroke(getBondStrokes(FontLayer, CC[1]));
// text("O", BondXstart + (1.45 * windowWidth) / 8, BondYstart);

// fill(getBondFill(FontLayer, CC[2]));
// stroke(getBondStrokes(FontLayer, CC[2]));
// text("N", BondXstart + (1.57 * windowWidth) / 4, BondYstart);

// fill(getBondFill(FontLayer, CC[3]));
// stroke(getBondStrokes(FontLayer, CC[3]));
// text("D", BondXstart + (2.33 * windowWidth) / 4, BondYstart);

// strokeWeight((strokeScale * 10) / 12);
// fill(getBondFill(2, CC[0]));
// stroke(getBondStrokes(2, CC[0]));
// text(Letter2print, BondXstart, BondYstart);

// fill(getBondFill(2, CC[1]));
// stroke(getBondStrokes(2, CC[1]));
// text("O", BondXstart + (1.45 * windowWidth) / 8, BondYstart);

// fill(getBondFill(2, CC[2]));
// stroke(getBondStrokes(2, CC[2]));
// text("N", BondXstart + (1.57 * windowWidth) / 4, BondYstart);

// fill(getBondFill(2, CC[3]));
// stroke(getBondStrokes(2, CC[3]));
// text("D", BondXstart + (2.33 * windowWidth) / 4, BondYstart);

// strokeWeight(strokeScale / 6);
// fill(getBondFill(3, CC[0]));
// stroke(getBondStrokes(3, CC[0]));
// text("B", BondXstart, BondYstart);

// fill(getBondFill(3, CC[1]));
// stroke(getBondStrokes(3, CC[1]));
// text("O", BondXstart + (1.45 * windowWidth) / 8, BondYstart);

// fill(getBondFill(3, CC[2]));
// stroke(getBondStrokes(3, CC[2]));
// text("N", BondXstart + (1.57 * windowWidth) / 4, BondYstart);

// fill(getBondFill(3, CC[3]));
// stroke(getBondStrokes(3, CC[3]));
// text("D", BondXstart + (2.33 * windowWidth) / 4, BondYstart);
